...
class ArtikelActivity : AppCompatActivity() {
    ...
    private fun loadArtikelData(artikelId: String) {
    ...
    private fun simpanKeFirestore(
        ...
        if (id != null) {
            db.collection("artikel")
                .document(id!!)
                .update(artikel as Map<String, Any>)
                ...
                .addOnFailureListener { e ->
                    Toast.makeText(
                        this,
                        "Gagal update artikel: ${e.message}",
                        Toast.LENGTH_SHORT
                    ).show()
                }
        } else {
            db.collection("artikel")
                ...
                .addOnFailureListener { e ->
                    Toast.makeText(
                        this,
                        "Gagal menambahkan artikel: ${e.message}",
                        Toast.LENGTH_SHORT
                    ).show()
                }
        }
